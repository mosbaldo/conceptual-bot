...
module.exports = function(fbController, slackController) {
    ...
    require("fs").readdirSync(normalizedPath).forEach(function(file) {
        require("./express_middleware/" + file)(webserver, fbController);
    }); */
    ...
    require("fs").readdirSync(fbNormalizedPath).forEach(function(file) {
      require("./facebook/routes/" + file)(webserver, fbController);
    });
    ...
    require("fs").readdirSync(slackNormalizedPath).forEach(function(file) {
      require("./slack/routes/" + file)(webserver, slackController);
    });

    fbController.webserver = webserver;
